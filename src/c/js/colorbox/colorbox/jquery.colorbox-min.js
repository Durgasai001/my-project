...
(function(b, gb) {
    ...
    c.init = function() {
        ...
        E = e("Wrapper");
        s = e("Content").append(l = e(N, "width:0; height:0"), L = e("LoadingOverlay").add(e("LoadingGraphic")), T = e("Current"), J = e("Next"), I = e("Previous"), z = e("Slideshow"));
        E.append(e().append(e("TopLeft"), Y = e("TopCenter").append(U = e("Title"), V = e("Close")), e("TopRight")), e().append(Z = e("MiddleLeft"), s, ab = e("MiddleRight")), e().append(e("BottomLeft"), bb = e("BottomCenter"), e("BottomRight"))).children().children().css({"float":"left"});
        ...
        I.click(c.prev);
        V.click(c.close);
        V.hover(function(){$(this).addClass('hover')}, function(){$(this).removeClass('hover')});
