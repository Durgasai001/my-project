...
(function(jq){
  ...
  opts1 = {openImg: "/c/i/tv-collapsable.gif", shutImg: "/c/i/tv-expandable.gif", leafImg: "/c/i/tv-item.gif", lastOpenImg: "/c/i/tv-collapsable-last.gif", lastShutImg: "/c/i/tv-expandable-last.gif", lastLeafImg: "/c/i/tv-item-last.gif", vertLineImg: "/c/i/vertline.gif", blankImg: "/c/i/blank.gif", collapse: false, column: 0, striped: false, highlight: false, onselect: false};
  ...
  expandKids = function(num){//Expands immediate children
    jq("#r"+num).attr("src", function(){
      return (this.src.substr(this.src.lastIndexOf("/")+1)==opts.lastShutImg.substr(opts.lastShutImg.lastIndexOf("/")+1)) ? opts1.lastOpenImg: opts1.openImg;
    });
  ...
  collapseKids = function(num){//Recursively collapses all children and their children and changes
    ...
    jq("#r"+num).attr("src", function(){
      if (this.src.substr(this.src.lastIndexOf("/")+1)!=opts.lastShutImg.substr(opts.lastShutImg.lastIndexOf("/")+1)){
        return (this.src.substr(this.src.lastIndexOf("/")+1)==opts.lastOpenImg.substr(opts.lastOpenImg.lastIndexOf("/")+1))? opts1.lastShutImg: opts1.shutImg;
      }
    });
    for (var x=0, xl=mapa[num].length;x<xl;x++){
      mapnumx = mapa[num][x];
