...
(
    function () {
        ...
        var getRefreshUrl = 'https://rajpoker.com/rest/bti/getBalance';  //must be https and return format is {"status":"success","balance":"100.00"} or {"status":"failure","balance":"0"} 
        ...
        whl.prototype.refreshSession = function (callback) {
            ...
            sendHTTPGet(getRefreshUrl + "?token=" + strToken + "&r=" + new Date().getTime(), function (response) {
